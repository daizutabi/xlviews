...
def rng_impl(addr: str, sheet_module: Sheet):
...
@pytest.fixture(scope="module")
def addr_impl(rng_impl: RangeImpl, include_sheetname: bool, external: bool):
    return rng_impl.get_address(include_sheetname=include_sheetname, external=external)


def test_range_int_int(rng_impl: RangeImpl, include_sheetname: bool, external: bool):
...
def test_range_tuple_last(rng_impl: RangeImpl, include_sheetname: bool, external: bool):
...
def test_offset(rng: Range, rng_impl: RangeImpl, row_offset: int, column_offset: int):
...
def test_iter_addresses(rng: Range, rng_impl: RangeImpl, external: bool):
    x = list(rng.iter_addresses(external=external))
    y = [r.get_address(external=external) for r in rng_impl]
    assert x == y


def test_iter_addresses_formula(rng: Range, rng_impl: RangeImpl, external: bool):
